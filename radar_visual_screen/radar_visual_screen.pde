...
try {
  ...
  distance= data.substring(index1+1, data.length()-2); // read the data from position "index1" to the end of the data pr thats the value of the distance
  //System.out.println(distance);
  // converts the String variables into Integer
  iAngle = int(angle);
  iDistance = Integer.parseInt(distance);
  System.out.println(iAngle+ " " + iDistance);
  }
